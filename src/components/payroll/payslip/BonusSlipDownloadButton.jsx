...
const BonusSlipDownloadButton = ({
  ...
  const handleDownload = async () => {
    if (!bonusSlipRef.current) return;
    ...
    try {
      ...
      const filename = `BonusSlip_${employeeName}_${employeeId}_${date}.pdf`;
      pdf.save(filename);
    } catch (error) {
...
export default BonusSlipDownloadButton;
