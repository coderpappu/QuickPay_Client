...
import { useCreateNewDesignationMutation, useGetDesignationDetailsQuery, useUpdateDesignationMutation, useGetCompanyIdQuery } from '../../features/api';
...
const DesignationForm = () => {
    ...
    const { data: designation,isLoading:isDesignationLoading } = useGetDesignationDetailsQuery(id, { skip: !id });
        ...
        <div >
            <Formik
                ...
                onSubmit={async (values, { setSubmitting }) => {
                    const { name } = values;
                    if (id == null) {
                        await createNewDesignation({ name, company_id: companyId }).then((res) => {
                            if (res.error != null) {
                        ...
                        await updateDesignation({ id, name }).then((res) => {
                            if (res.error != null) {
                                toast.error(res.error.data.msg);
                            } else {
